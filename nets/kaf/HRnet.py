...
class HRNet(nn.Module):
    def __init__(self, c=48, num_classes=80, num_relations=14, bn_momentum=0.1):
        ...
        self.hmap = nn.Conv2d(c, num_classes, kernel_size=(1, 1), stride=(1, 1))
        self.regs = nn.Conv2d(c, 2, kernel_size=(1, 1), stride=(1, 1))
        self.w_h_ = nn.Conv2d(c, 2, kernel_size=(1, 1), stride=(1, 1))
        self.raf = nn.Conv2d(c, 2 * num_relations, kernel_size=(1, 1), stride=(1, 1))
